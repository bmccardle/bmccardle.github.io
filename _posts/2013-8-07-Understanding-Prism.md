...
You will need to use cancelling and compounding prism when splitting prism for cosmetic reasons or when applying [ANSI Standards][6]. In order to apply ANSI Standards we need to find out the amount of prism per lens using Prentice's Rule.
...
\begin{aligned}
P &= 0.15 \times 3\\\\ &= 0.45^{\Delta}OD\\\\ P &= 0.15 \times 4\\\\ &= 0.60^{\Delta}OS \end{aligned}

Now we determine base direction _Please note we did use the sign for the power, there is no need too_
...
Again, look at the triangle that the pupil is in and notice that the base is out for both eyes. BO in both eyes will compound so we have a total of 0.75$^{\Delta}$. If you have an Rx with cylinder you will need to find the power in the meridian in which you are looking for the prism. For example, if you are looking for horizontal prism you need to find the power on the $180^{th}$ and if you are looking for the vertical prism you need to find the power on the $90^{th}$ meridian. If you are unsure how to find the power on these meridians, read my walk through on the [oblique meridian formula][9]

[1]: http://lh6.ggpht.com/_gd74B03pqrE/Sp2wDDfkZYI/AAAAAAAAAPs/XzKCIDSVSeU/BU%20Prism.jpg
[2]: http://lh3.ggpht.com/_gd74B03pqrE/SwLP7HQArgI/AAAAAAAAA6c/cMFf2AnjXKQ/BD%20Prism1.png
[3]: http://lh4.ggpht.com/_gd74B03pqrE/SwLkIkN72lI/AAAAAAAAA6g/6ahPbtiDPxE/BU%20Prism1.png
[4]: http://lh3.ggpht.com/_gd74B03pqrE/Sp2wDcCkXiI/AAAAAAAAAPw/lJgAvzETG7Q/BI%20Prism.jpg
[5]: http://lh5.ggpht.com/_gd74B03pqrE/Sp2wDr3ZX5I/AAAAAAAAAP0/CSA389oi620/BO%20Prism.jpg
[6]: http://opticampus.com/tools/ansi/php
[7]: http://lh5.ggpht.com/_gd74B03pqrE/SwRIsJzQ39I/AAAAAAAAA6k/QK3z90u9jFg/Understanding-Prism1.png"
[8]: http://lh3.ggpht.com/_gd74B03pqrE/SwRSUYzdmHI/AAAAAAAAA6o/h1MyIOMylyU/Understanding-Prism2.png"
[9]: http://brent.mccardle.me/blog/category/2014/12/oblique-meridian
